...
These are the final 5 maps that we are deciding between. The legend refers to the clustering transformation, standardisation and clustering method. Please also look at the associated bar charts as and descriptions for each cluster provided. We want to be able to make the best story and which makes the most sense in terms of cluster. Please let us know your comments as only one can be used. 
